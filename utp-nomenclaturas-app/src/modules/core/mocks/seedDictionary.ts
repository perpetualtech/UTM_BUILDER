...
/**
 * Espejo del bundle que sirve GET /config en el backend real (Anexo A/B
 * del SDD, sembrado en utp_nomenclaturas/config/install/*.yml, Fase 0).
 * Usado solo por los mocks de MSW — el backend real es la fuente de
 * verdad, esto solo replica su contenido para desarrollo/tests.
 */
export const seedDictionary: DictBundle = {
  lists: {
